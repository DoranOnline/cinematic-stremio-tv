...
const NavTabButton = ({ className, logo, icon, label, href, selected, onClick }) => {
    ...
    return (
        <Link className={classnames(className, styles['nav-tab-button-container'], { 'selected': selected })} title={label} tabIndex={0} to={href} onClick={onClick} onDoubleClick={onDoubleClick}>
            {
